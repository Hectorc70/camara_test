...
import 'package:camera_test/mlkit_utils.dart';
...
class CameraFacePage extends StatefulWidget {
  ...
  @override
  State<CameraFacePage> createState() => _CameraPageState();
}

class _CameraPageState extends State<CameraFacePage> {
          ...
          if (!snapshot.hasData) {
            ...
            return StreamBuilder<FaceDetectionModel>(
              ...
              builder: (_, faceModelSnapshot) {
                print('FACE STATUS: ======= ${faceModelSnapshot.hasData}');
